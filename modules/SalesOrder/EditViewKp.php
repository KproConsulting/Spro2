...
if (!$processMakerView) {
	if (isset ($_REQUEST['record']) && $_REQUEST['record'] != '') {
		if (isset ($_REQUEST['convertmode']) && $_REQUEST['convertmode'] == 'quotetoso') {
			...
			/* kpro@tom150620181140 migrazione vte18.05 */
			/* kpro@bid16112017 */
			$focus->column_fields['kp_business_unit'] = $quote_focus->column_fields['kp_business_unit']; 
			$focus->column_fields['mod_pagamento'] = $quote_focus->column_fields['mod_pagamento']; 
			$focus->column_fields['kp_agente'] = $quote_focus->column_fields['kp_agente']; 
	...
	if (isset($_REQUEST['account_id']) && $_REQUEST['account_id'] != '' && is_numeric($_REQUEST['account_id']) && $_REQUEST['record'] == '' && $_REQUEST['convertmode'] != 'update_quote_val') { //crmv@160371
		...
		/* kpro@bid16112017 end */
		/* kpro@bid24112017 */
		$focus->column_fields['kp_agente'] = $acct_focus->column_fields['kp_agente'];
		/* kpro@bid24112017 end */
