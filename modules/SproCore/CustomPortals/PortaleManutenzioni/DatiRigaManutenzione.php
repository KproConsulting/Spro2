...
if(isset($_GET['riga_manutenzione'])){
    ...
    $q_riga_manutenzione = "SELECT 
                            ...
                            com.nome_componente nome_componente,
                            ...
                            INNER JOIN {$table_prefix}_compimpianto com ON com.compimpiantoid = righe.kp_componente
    ...
    if($adb->num_rows($res_riga_manutenzione)>0){
        ...
        $vendorname = $adb->query_result($res_riga_manutenzione,0,'vendorname');
        $vendorname = html_entity_decode(strip_tags($vendorname), ENT_QUOTES,$default_charset);
        if($vendorname == NULL){
            $vendorname = "";
        }
        
        $impianto_name = $adb->query_result($res_riga_manutenzione,0,'impianto_name');
