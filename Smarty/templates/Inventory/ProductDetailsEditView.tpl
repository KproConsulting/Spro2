...
<div id="block_{$PRODBLOCKINFO.blockid}" class="editBlock" style="{if $PANELID != $PRODBLOCKINFO.panelid}display:none{/if}"> {* crmv@104568 *}
...
<script type="text/javascript">
	...
	/* kpro@tom221220171400 */
	$("status").style.display = "inline";
	jQuery.fancybox.showLoading();
	/* kpro@tom221220171400 end */
