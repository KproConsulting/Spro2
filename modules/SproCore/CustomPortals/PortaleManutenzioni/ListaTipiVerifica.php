...
if(isset($_GET['manutenzione']) && isset($_GET['riga_manutenzione'])){
    ...
    $q_tipo_verifica = "SELECT 
                        ...
                        WHERE ent.deleted = 0 AND es.kp_riga_manutenz = ".$riga_manutenzione;
    ...
    for($i=0; $i<$num_tipo_verifica; $i++){
        ...
        $q_documenti = "SELECT COALESCE(COUNT(*), 0) numero_documenti
                        ...
                        WHERE ent.deleted = 0 AND senote.crmid =".$tipo_verifica."
                        ORDER BY title ASC";
