...
jQuery(document).ready(function() {
	...
	if (themeOptions.replaceAlerts) {
		...
		window.alert = window.vtealert = function(text, cb, options) {
			...
			if (options.html) {
				jQuery('#alert-dialog-content').html(text);
			} else {
			...
			if (options.autoclose > 0) {
		        ...
		        jQuery('.modal-content').mouseenter(function(){
		...
		window.vteconfirm = function(text, cb, options) {
			...
			if (options.html) {
				jQuery('#confirm-dialog-content').html(text);
			} else {
			...
			if (options.width != '') jQuery('#confirm-dialog').find('.modal-dialog').css('width', options.width); else jQuery('#confirm-dialog').find('.modal-dialog').css('width','');
