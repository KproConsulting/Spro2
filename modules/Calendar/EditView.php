...
//kpro@tom250520171804
if (isset($_REQUEST['from_module'])){
	...
	elseif( $_REQUEST['from_module'] == "Visitreport"){
		$focus->column_fields["activitytype"] = "Visita";
	}

}
//kpro@tom250520171804 end
