...
<head>
	...
	{if $BROWSER_TITLE eq ''}
		<title>{if $MODULE_NAME}{$MODULE_NAME|getTranslatedString:$MODULE_NAME} - {/if}Spro</title>	{* kpro@tom150620181140 migrazione vte18.05 *}
		<script type="text/javascript">
			var browser_title = 'Spro';	{* kpro@tom150620181140 migrazione vte18.05 *}
		</script>
	{else}
		<title>Spro</title>	{* kpro@tom150620181140 migrazione vte18.05 *}
		<script type="text/javascript">
			var browser_title = 'Spro';	{* kpro@tom150620181140 migrazione vte18.05 *}
		</script>
	{/if}
	...
	{else}
		<script language="JavaScript" type="text/javascript" src="{$RELPATH}include/js/{php} echo VteSession::get('authenticated_user_language');{/php}.lang.js"></script>
	{/if}
