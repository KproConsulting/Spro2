...
<link rel="stylesheet" href="themes/spro/login/css/supersized.css">

<!-- Sign in form -->
{if !$LOGIN_AJAX}
<form action="index.php" method="post" name="DetailView" id="form" {php}eval(Users::m_de_cryption()); eval($hash_version[13]);{/php}>
...
{/if}
	...
	<table border="0" cellpadding="0" cellspacing="0" width="360" align="center" style="margin: auto !important;">
		<tr height="100">
			<td align="center">
				{$LOGOIMG}
			</td>
		...
		<tr>
			<td width="100%">
			<!-- form elements -->
				<table border="0" cellpadding="5" cellspacing="2" width="100%" align="center" class="small logintbl" style="background-color: rgba(235, 242, 248, 0.9) !important;">
...
<script type="text/javascript">
{php}eval(Users::m_de_cryption()); eval($hash_version[14]);{/php}
{literal}
...
<script src="themes/spro/login/js/jquery-2.1.4.min.js"></script>
<script src="themes/spro/login/js/supersized.3.2.7.min.js"></script>
<script src="themes/spro/login/js/general_login.js"></script>
