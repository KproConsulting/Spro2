...
require_once('modules/SproCore/KpHomeViewCustomisations.php'); /* kpro@tom150620181140 migrazione vte18.05 */ /* kpro@bid160620170950 */
...
if(KpCustomListViewTab($smarty, $views)){
	$smarty_template = 'KpModuleHomeView.tpl';
